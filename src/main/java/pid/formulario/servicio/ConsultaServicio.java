...
import pid.formulario.repositorio.ConsultaRepositorio;

@Service
public class ConsultaServicio implements ConsultaRepositorio{
    ...
    @Override
    public void deleteAllInBatch(Iterable<Consulta> entities) {
    ...
    @Override
    public Consulta getById(Long arg0) {
        return null;
    }

    @Override
    public Consulta getOne(Long arg0) {
        return null;
    }
    ...
    @Override
    public <S extends Consulta> List<S> saveAllAndFlush(Iterable<S> entities) {
        return null;
    }
    ...
    @Override
    public <S extends Consulta, R> R findBy(Example<S> example, Function<FetchableFluentQuery<S>, R> queryFunction) {
        // TODO Auto-generated method stub

...
import pid.formulario.repositorio.PacienteRepositorio;

@Service
public class PacienteServicio implements PacienteRepositorio {
    @Autowired
    ...
    public <S extends Paciente> S save(S entity) {
        identificador = entity.getIdPaciente();
        return pacienteRepositorio.save(entity);
    }
